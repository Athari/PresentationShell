...
{
    /// <summary>The KNOWNFOLDERID constants represent GUIDs that identify standard folders registered with the system as Known Folders. These folders are installed with Windows Vista and later operating systems, and a computer will have only folders appropriate to it installed.
    /// See http://msdn.microsoft.com/en-us/library/windows/desktop/dd378457(v=vs.85).aspx </summary>
