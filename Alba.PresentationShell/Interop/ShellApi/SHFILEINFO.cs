...
namespace Alba.Interop.ShellApi
{
    ...
    internal struct SHFILEINFO
    {
        ...
        public int iIcon;
        /// <summary>An array of values that indicates the attributes of the file object. For information about these values, see the IShellFolder::GetAttributesOf method.</summary>
        ...
        [MarshalAs (UnmanagedType.ByValTStr, SizeConst = Native.MAX_PATH)]
        public string szDisplayName;
        /// <summary>A string that describes the type of file.</summary>
        [MarshalAs (UnmanagedType.ByValTStr, SizeConst = Native.MAX_TYPE)]
